...
- Works only for `revealjs` output (configurable for other formats).
...
Both `## Nested headings work too` and `### Still diving` were inserted by the filter.
Only parent headings above this `###` level are repeated.
