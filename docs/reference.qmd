...
| `shift` | integer | `0` | The `shift-heading-level-by` applied to the document. May be negative. A value that is not a whole number, or that moves the slide level outside the range 1 to 6, is reported and ignored. |
...
Four things are reported at render time, and none of them stops the render:
